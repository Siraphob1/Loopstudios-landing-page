...
const HeaderComponent = () => {
  ...
  return (
    <header className="w-full text-white">
        <div className={menuclick   ?" hidden lg:block lg:w-full lg:relative "  :"w-full relative"}>
            ...
            <div className=" absolute top-0 w-full p-[2rem] lg:px-[10rem] lg:pt-[4rem]">
                <section className="flex  justify-between w-full ">
                    ...
                    <ul className="hidden lg:flex">
                        <li className="nav-link"><a href="#leader">About</a></li>
                        <li className="nav-link"><a href="#leader">Careers</a></li>
                        <li className="nav-link"><a href="#creation">Events</a></li>
                        <li className="nav-link"><a href="#creation">Products</a></li>
                        <li className="nav-link"><a href="#support">Support</a></li>
                    </ul>
            ...
            <div className=" lg:block absolute top-1/2 -translate-y-1/3 px-[1.5rem] lg:px-[10rem] ">
                <div className="border-white border-[3px] text-[2.1rem]  font-Josefin font-light  uppercase leading-[2.1rem] max-w-[650px] p-[1.5rem]
                                lg:text-[4rem]  lg:tracking-[0.25rem] lg:leading-[4.1rem]  lg:p-[2.5rem] ">
                    Immersive experiences that deliver
                </div>
            </div>  
        </div>
        <div className={menuclick ?"block lg:hidden" :"hidden"}>
