...
const Section1Component = () => {
  return (
    <section className=" relative ">
        ...
        <div className=" static top-0  bg-white    pt-[2rem] px-[1rem]  text-center
                        lg:absolute lg:top-[40%] lg:bottom-0 lg:right-0  lg:w-[600px]  lg:text-start lg:px-[4.8rem] lg:pt-[4.8rem]">
